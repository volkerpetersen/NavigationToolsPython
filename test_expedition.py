# https://pypi.org/project/Expedition-Python/
#https://github.com/TTCMarine/Expedition-Python
...
EXPEDITION_INSTALL_PATH = os.path.normpath("C:\\Program Files (x86)\\Expedition\\Expedition")

class TestExpedition(unittest.TestCase):
    def setUp(self):
        #architecture = platform.architecture()[0]
        #version = "64"
        #print(f"64 bit: {(version in architecture)}")
        ...
        #self.expedition = ExpeditionDLL(EXPEDITION_INSTALL_PATH)
